...
allowed-tools: Bash(RAWGROWTHOS_DIR=* ~/.venv/bin/python3 ~/.config/gmail/gmail.py *)
---
...
The Gmail CLI reads credential paths from environment variables, loaded from RawgrowthOS's `.env` via `RAWGROWTHOS_DIR`. Every command MUST use this prefix:

```
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS
```
...
```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py list --all
```
...
```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py list --hours 48
```

### Read full email

```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py read <msg_id>
```

### Move email to label/folder

```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py move <msg_id> "Label Name"
```
...
```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py labels
```

### Reply to an email

```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py reply <msg_id> "Your reply body here"
```
...
```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py reply <msg_id> "Your reply body here" --attachments "/path/to/file1.pdf,/path/to/file2.png"
```

### Send a new email

```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py send "to@example.com" "Subject here" "Body here"
```

### Send with attachments

```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py send "to@example.com" "Subject" "Body" --attachments "/path/to/file.pdf,/path/to/other.xlsx"
```

### Create a Gmail filter (auto-sort rule)

```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py filter --from "sender@example.com" --label "LabelName" --archive --read
```
...
```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py filters
```

### Re-authenticate

```bash
RAWGROWTHOS_DIR=/Users/scanbot/RawgrowthOS ~/.venv/bin/python3 ~/.config/gmail/gmail.py auth
```
