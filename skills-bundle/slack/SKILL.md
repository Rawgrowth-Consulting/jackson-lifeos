...
The CLI lives at the RawgrowthOS project root:

```bash
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js <command>
```

### List conversations (with unread counts)

```bash
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js list
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js list --limit 10
```
...
```bash
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js read <channel_id>
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js read <channel_id> --limit 30
```
...
```bash
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js send <channel_id> "message text"
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js send <channel_id> "reply text" --thread-ts 1234567890.123456
```

### Search conversations by name

```bash
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js search "jane"
cd /Users/scanbot/RawgrowthOS && node dist/slack-cli.js search "general"
```
