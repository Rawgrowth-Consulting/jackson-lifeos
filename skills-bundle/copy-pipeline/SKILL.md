...
```bash
cat sales/copy-library/COPY-ANALYSIS.md
```
...
- `brand/voice.md` — voice profile and rules
- `ops/strategy/offer/undeniable-offer.md` — offer structure, pricing, positioning
- `brand/identity/02-icp.md` — who we're talking to
...
### 3a. Brand Voice
Read `brand/voice.md` for Chris's exact voice rules:
