...
1. Look up the contact in Obsidian knowledge vault if available: grep -r "[contact name]" /Users/scanbot/RawgrowthOS/clients/
...
sqlite3 "$PROJECT_ROOT/store/rawgrowthos.db" "INSERT INTO hive_mind (agent_id, chat_id, action, summary, artifacts, created_at) VALUES ('comms', '$CHAT_ID', 'clickup_run', 'Ran /clickup. Executed N actions, skipped N, N need Chris.', NULL, strftime('%s','now'));"
```
