...
1. **Brand Foundation v2:** Read brand/identity/12-brand-positioning.md -- Positioning, voice, what we do. This is the source of truth.
2. **Voice Profile:** Read brand/voice.md
3. **Hook Frameworks:** Read content/docs/frameworks/hook-frameworks.md -- 23+ hook patterns

## For YouTube (ALL 4 required before scripting)
4. **YouTube Strategy:** Read content/docs/platforms/youtube.md
5. **YT GPT System:** Read content/docs/frameworks/yt-gpt-system.md (if exists) -- Full scripting methodology
6. **YouTube Principles:** Read content/docs/frameworks/youtube-principles.md (if exists)
7. **7-Point Pre-Production Checklist (NON-NEGOTIABLE):** Read content/docs/frameworks/youtube-checklist.md -- Run every check before scripting. Source: https://docs.google.com/document/d/1wUSJpv8tgAphvFbplionshNlnJF2fBj6POQDo4CgNnQ/edit

## For Instagram/Reels
8. **Instagram Strategy:** Read content/docs/frameworks/07-instagram.md
9. **IG Strategy KB:** Read content/docs/platforms/instagram/instagram-strategy-kb.md
10. **Instagram Hook Patterns:** Read content/docs/frameworks/instagram-hook-patterns.md (skip if not yet created)

## For Ideas/Research
11. **Idea Synthesis:** Read content/docs/frameworks/idea-synthesis.md
12. **Competitor Analysis:** Read research/competitor/competitor-analysis.md
...
Read brand/ -- never fabricate. Real numbers only.

## Paid Content Ad Strategies (Jeremy Haynes Frameworks)
Full reference: research/stolen/ (browse for frameworks)
