...
Every Rawgrowth agent follows this 6-step cycle. No exceptions. This is the flywheel in action at the agent level.
...
- Brand voice profile: `brand/identity/01-personal-profile.md`
- Relevant brand docs from `brand/`
- Relevant frameworks from `content/docs/frameworks/`
- Relevant SOPs from `ops/delivery/sops/`
...
- Check frameworks and templates in `content/docs/frameworks/`
...
- Include real numbers from `brand/09-results.md` — never fabricate
